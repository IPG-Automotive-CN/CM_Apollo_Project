...
inline void StopSign::clear_stop_sign_id() {
  stop_sign_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void StopSign::_internal_set_stop_sign_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  stop_sign_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void StopSign::set_stop_sign_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  stop_sign_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void StopSign::set_stop_sign_id(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  stop_sign_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* StopSign::_internal_mutable_stop_sign_id() {
  _has_bits_[0] |= 0x00000001u;
  return stop_sign_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* StopSign::release_stop_sign_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return stop_sign_id_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void StopSign::set_allocated_stop_sign_id(std::string* stop_sign_id) {
  ...
  stop_sign_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), stop_sign_id);
