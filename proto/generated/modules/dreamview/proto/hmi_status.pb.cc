...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_HMIStatus_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_HMIStatus_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto[3];
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 18, 35, sizeof(::apollo::dreamview::HMIStatus)},
};
...
const char descriptor_table_protodef_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "entsEntry\022\024\n\014docker_image\030\n \001(\t\022\023\n\013utm_z"
  "one_id\030\013 \001(\005\022\025\n\rpassenger_msg\030\014 \001(\t\032.\n\014M"
  "odulesEntry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\010:"
  "\0028\001\032[\n\030MonitoredComponentsEntry\022\013\n\003key\030\001"
  " \001(\t\022.\n\005value\030\002 \001(\0132\037.apollo.monitor.Com"
  "ponentStatus:\0028\001"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_sccs[3] = {
...
static bool descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto = {
  &descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_initialized, descriptor_table_protodef_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto, "modules/dreamview/proto/hmi_status.proto", 656,
  &descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_once, descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_sccs, descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_deps, 3, 2,
  schemas, file_default_instances, TableStruct_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto::offsets,
  file_level_metadata_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto, 3, file_level_enum_descriptors_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto, file_level_service_descriptors_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto), true);
namespace apollo {
namespace dreamview {
...
HMIStatus::HMIStatus(const HMIStatus& from)
  ...
  if (from._internal_has_current_mode()) {
    current_mode_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.current_mode_);
  }
  ...
  if (from._internal_has_current_map()) {
    current_map_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.current_map_);
  }
  ...
  if (from._internal_has_current_vehicle()) {
    current_vehicle_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.current_vehicle_);
  }
    ...
    switch (tag >> 3) {
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 88)) {
          ...
          utm_zone_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void HMIStatus::InternalSwap(HMIStatus* other) {
  ...
  current_mode_.Swap(&other->current_mode_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  current_map_.Swap(&other->current_map_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  current_vehicle_.Swap(&other->current_vehicle_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
