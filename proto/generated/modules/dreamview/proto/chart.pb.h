...
public:
  ...
  Line_PropertiesEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
public:
  ...
  Polygon_PropertiesEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
inline void Options_Axis::clear_label_string() {
  label_string_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void Options_Axis::_internal_set_label_string(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  label_string_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Options_Axis::set_label_string(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  label_string_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Options_Axis::set_label_string(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  label_string_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* Options_Axis::_internal_mutable_label_string() {
  _has_bits_[0] |= 0x00000001u;
  return label_string_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Options_Axis::release_label_string() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return label_string_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Options_Axis::set_allocated_label_string(std::string* label_string) {
  ...
  label_string_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), label_string);
