...
static void InitDefaultsscc_info_MPCControllerConf_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto() {
  ...
  ::apollo::control::MPCControllerConf::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::control::MPCControllerConf, unconstraint_control_diff_limit_),
  5,
  6,
  7,
  8,
...
const char descriptor_table_protodef_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "raint_control_diff_limit\030\030 \001(\001"
  ;
...
static bool descriptor_table_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto = {
  &descriptor_table_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto_initialized, descriptor_table_protodef_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto, "modules/control/proto/mpc_controller_conf.proto", 990,
...
static bool dynamic_init_dummy_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto), true);
namespace apollo {
namespace control {
...
void MPCControllerConf::InitAsDefaultInstance() {
  ::apollo::control::_MPCControllerConf_default_instance_._instance.get_mutable()->lat_err_gain_scheduler_ = const_cast< ::apollo::control::GainScheduler*>(
      ::apollo::control::GainScheduler::internal_default_instance());
  ::apollo::control::_MPCControllerConf_default_instance_._instance.get_mutable()->heading_err_gain_scheduler_ = const_cast< ::apollo::control::GainScheduler*>(
      ::apollo::control::GainScheduler::internal_default_instance());
  ::apollo::control::_MPCControllerConf_default_instance_._instance.get_mutable()->steer_weight_gain_scheduler_ = const_cast< ::apollo::control::GainScheduler*>(
      ::apollo::control::GainScheduler::internal_default_instance());
  ::apollo::control::_MPCControllerConf_default_instance_._instance.get_mutable()->feedforwardterm_gain_scheduler_ = const_cast< ::apollo::control::GainScheduler*>(
      ::apollo::control::GainScheduler::internal_default_instance());
  ::apollo::control::_MPCControllerConf_default_instance_._instance.get_mutable()->calibration_table_ = const_cast< ::apollo::control::calibrationtable::ControlCalibrationTable*>(
...
class MPCControllerConf::_Internal {
 public:
  ...
  static void set_has_unconstraint_control_diff_limit(HasBits* has_bits) {
    (*has_bits)[0] |= 2097152u;
  }
};
...
MPCControllerConf::MPCControllerConf(const MPCControllerConf& from)
  ...
  ::memcpy(&ts_, &from.ts_,
    static_cast<size_t>(reinterpret_cast<char*>(&unconstraint_control_diff_limit_) -
    reinterpret_cast<char*>(&ts_)) + sizeof(unconstraint_control_diff_limit_));
...
void MPCControllerConf::SharedCtor() {
  ...
  ::memset(&lat_err_gain_scheduler_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&unconstraint_control_diff_limit_) -
      reinterpret_cast<char*>(&lat_err_gain_scheduler_)) + sizeof(unconstraint_control_diff_limit_));
}
...
// @@protoc_insertion_point(message_clear_start:apollo.control.MPCControllerConf)
  ...
  if (cached_has_bits & 0x003f0000u) {
    ::memset(&standstill_acceleration_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&unconstraint_control_diff_limit_) -
        reinterpret_cast<char*>(&standstill_acceleration_)) + sizeof(unconstraint_control_diff_limit_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 23:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 184)) {
          ...
          enable_mpc_feedforward_compensation_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 24:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 193)) {
          _Internal::set_has_unconstraint_control_diff_limit(&has_bits);
          unconstraint_control_diff_limit_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* MPCControllerConf::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00200000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(24, this->_internal_unconstraint_control_diff_limit(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.control.MPCControllerConf)
  ...
  if (cached_has_bits & 0x003f0000u) {
    ...
    if (cached_has_bits & 0x00200000u) {
      unconstraint_control_diff_limit_ = from.unconstraint_control_diff_limit_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
}
...
void MPCControllerConf::InternalSwap(MPCControllerConf* other) {
  ...
  swap(unconstraint_control_diff_limit_, other->unconstraint_control_diff_limit_);
}
...
template<> PROTOBUF_NOINLINE ::apollo::control::MPCControllerConf* Arena::CreateMaybeMessage< ::apollo::control::MPCControllerConf >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::control::MPCControllerConf >(arena);
}
