...
static bool descriptor_table_modules_2fcontrol_2fproto_2fpid_5fconf_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fproto_2fpid_5fconf_2eproto = {
  &descriptor_table_modules_2fcontrol_2fproto_2fpid_5fconf_2eproto_initialized, descriptor_table_protodef_modules_2fcontrol_2fproto_2fpid_5fconf_2eproto, "modules/control/proto/pid_conf.proto", 215,
...
static bool dynamic_init_dummy_modules_2fcontrol_2fproto_2fpid_5fconf_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_modules_2fcontrol_2fproto_2fpid_5fconf_2eproto), true);
namespace apollo {
namespace control {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          integrator_enable_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
