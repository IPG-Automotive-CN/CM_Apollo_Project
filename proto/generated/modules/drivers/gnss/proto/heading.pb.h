...
inline void Heading::clear_station_id() {
  station_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void Heading::_internal_set_station_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  station_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Heading::set_station_id(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  station_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Heading::set_station_id(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  station_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* Heading::_internal_mutable_station_id() {
  _has_bits_[0] |= 0x00000001u;
  return station_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Heading::release_station_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return station_id_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Heading::set_allocated_station_id(std::string* station_id) {
  ...
  station_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), station_id);
