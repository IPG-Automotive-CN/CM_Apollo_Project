...
inline ::apollo::drivers::racobit_radar::CanConf* RacobitRadarConf::_internal_mutable_can_conf() {
  ...
  if (can_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::drivers::racobit_radar::CanConf>(GetArenaNoVirtual());
    can_conf_ = p;
  }
  return can_conf_;
}
...
inline ::apollo::drivers::racobit_radar::RadarConf* RacobitRadarConf::_internal_mutable_radar_conf() {
  ...
  if (radar_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::drivers::racobit_radar::RadarConf>(GetArenaNoVirtual());
    radar_conf_ = p;
  }
  return radar_conf_;
}
