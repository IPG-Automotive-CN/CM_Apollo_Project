...
static const char *CompileLibs[] = {
    ...
    "libcar4sl.a	CarMaker-Car linux64 11.0 2022-03-30",
    "libcarmaker4sl.a	CarMaker linux64 11.0 2022-03-30",
...
static const char *CompileFlags[] = {
    ...
    "-fno-stack-protector -Wlogical-op -DCM4SL",
    "-D_GNU_SOURCE -m64 -fno-strict-aliasing -pthread",
    "-fexceptions",
    NULL
};
...
tAppStartInfo   AppStartInfo = {
    ...
    "114",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "dagobert.ipg",         /* App_CompileSystem   */
    "2022-03-30 10:40:59",  /* App_CompileTime */
